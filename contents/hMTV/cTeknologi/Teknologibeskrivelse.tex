...
Overordnet består et Fitbit Flex aktivitetsarmbånd af en flex tracker, oplader kabel, trådløs synkroniserings dongle og armbånd til flex tracker (KILDE PÅ). Disse kan ligeledes ses af \autoref{fig:fitbitflexindhold}. 
\end{enumerate}
...
Fitbit Flex er i stand til at måle antal skridt, forbrændte kalorier, afstanden der er rejst (ET ANDET ORD), minutter brugeren er aktiv og længden samt kvalitet af søvn. 
